...
export class BillingController {
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles(Role.SUPER_ADMIN)
    @ApiOperation({ summary: 'Open a hosted Checkout session for any company and plan (SUPER_ADMIN)' })
    ...
    @UseGuards(JwtAuthGuard, RolesGuard)
    @Roles(Role.SUPER_ADMIN)
    @ApiOperation({ summary: 'Switch an existing subscription between PRO and ENTERPRISE (SUPER_ADMIN)' })
