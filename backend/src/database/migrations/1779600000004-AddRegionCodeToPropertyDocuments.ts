...
// Documents carry unit_id / asset_id, so an existing document's region is
// derivable through the unit > asset > locality > city chain. Anything not
// linked to a property falls back to the company default.
export class AddRegionCodeToPropertyDocuments1779600000004
