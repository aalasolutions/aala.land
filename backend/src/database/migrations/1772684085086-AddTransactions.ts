...
export class AddTransactions1772684085086 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('rent', 'sale', 'deposit', 'maintenance', 'commission', 'other')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "FK_8733562c5e54c31dd1ba8f49915" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "FK_8733562c5e54c31dd1ba8f49915"`,
    );
