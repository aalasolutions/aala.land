...
export class AddLeases1772684723141 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."leases_type_enum" AS ENUM('RESIDENTIAL', 'COMMERCIAL')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "leases" ADD CONSTRAINT "FK_4ee8911a28f4a26ee919e8cf791" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "leases" DROP CONSTRAINT "FK_4ee8911a28f4a26ee919e8cf791"`,
    );
