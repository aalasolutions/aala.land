...
export class AddCommissions1772685033288 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."commissions_type_enum" AS ENUM('SALE', 'RENTAL', 'REFERRAL')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."commissions_status_enum" AS ENUM('PENDING', 'APPROVED', 'PAID', 'CANCELLED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "commissions" ADD CONSTRAINT "FK_72c5cb90cae74cf7ea1af139684" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "commissions" DROP CONSTRAINT "FK_72c5cb90cae74cf7ea1af139684"`,
    );
