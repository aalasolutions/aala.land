...
export class AddWhatsapp1772684535310 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."whatsapp_messages_status_enum" AS ENUM('QUEUED', 'SENT', 'DELIVERED', 'READ', 'FAILED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "whatsapp_messages" ADD CONSTRAINT "FK_9a9b15c757260582626aabcaa56" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "whatsapp_messages" DROP CONSTRAINT "FK_9a9b15c757260582626aabcaa56"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."whatsapp_messages_direction_enum"`,
    );
  }
}
