...
export const UUID_PATTERN =
  /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{3}-[0-9a-f]{12}$/i;
...
// ---------------------------------------------------------------------------
// Taxonomy lists authored for fields that had no frontend constant.
// Values are the existing backend enum members verbatim (the de-facto valid
// set); labels are human-readable. Single source of truth for these fields.
// ---------------------------------------------------------------------------
...
export const NOTIFICATION_TYPES = [
  ...
  { value: "CHEQUE_OVERDUE", label: "Cheque Overdue" },
  { value: "CHEQUE_DELAYED", label: "Cheque Delayed" },
...
// Canonical RBAC role values (users.role). Kept as a frozen PG enum in the
// backend; this list drives its @IsEnum validation and the drift guard.
// Distinct from ALL_ROLES above, which is an unrelated job-title dropdown.
